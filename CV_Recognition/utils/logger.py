...
utils/logger.py
===============
Structured JSON logger for the KHEMET CV Recognition service.
...
Usage:
    ...
    logger.info("Prediction complete", extra={"class_name": "Mask of Tutankhamun"})
"""

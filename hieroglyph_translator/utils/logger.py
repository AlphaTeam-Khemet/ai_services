...
utils/logger.py
===============
Structured JSON logger for the KHEMET Hieroglyph Translator service.
...
Usage:
    ...
    logger.info("Detection complete", extra={"symbol_count": 5})
"""
...
class StructuredFormatter(logging.Formatter):
    ...
    SERVICE_NAME = "hieroglyph_translator"
